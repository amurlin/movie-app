...
const NowPlayingSlider = () => {
  ...
  return (
    ...
    >
          ...
          >
            <Card className="cursor-pointer">
              <CardContent className="flex flex-col justify-center p-0 gap-4">
                ...
                <div className="absolute hidden sm:flex flex-col ml-[150px] gap-1 w-[300px] items-start text-white">
                  <p className="p-0 text-sm">Now playing:</p>
                  <CardHeader className="text-center text-2xl font-semibold p-0">
                    {movie.title}
                  </CardHeader>
      ...
      <CarouselPrevious className="absolute left-4 top-1/2 w-8 h-8 rounded-full sm:flex hidden items-center justify-center  transition z-10" />
      <CarouselNext className="absolute right-4 top-1/2 w-8 h-8 rounded-full sm:flex hidden items-center justify-center transition z-10" />
    </Carousel>
  );
};
